...
namespace IptFinals.Migrations
{
    /// <inheritdoc />
    ...
    //    YearLevel = table.Column<string>(type: "nvarchar(100)", nullable: false),
    ...
    //    EmergencyContact = table.Column<string>(type: "nvarchar(100)", nullable: false),
    //},
    //constraints: table =>
    //{
    //    table.PrimaryKey("PK_AspNetPersonalInfo", x => x.Id);
    //});
